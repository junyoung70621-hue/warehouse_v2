...
CENTERS = [
    ...
    "대전센터", "토스", "고객지원사업부",
    "에이텍본사", "티머니(버스)", "티머니(택시)", "외부창고",
]

REGIONAL = {"강서센터", "강북센터", "강동센터", "강남센터"}
SPECIAL  = {"택시지원파트", "리페어팀", "AFC지원파트", "고속/시외", "대전센터", "토스", "고객지원사업부"}
# 외부 창고 — 자재센터·admin만 이동 가능
EXTERNAL = {"에이텍본사", "티머니(버스)", "티머니(택시)", "외부창고"}

# 카테고리별 권장 도착 센터 (통합뷰 이동신청 필터용)
CATEGORY_DESTINATIONS = {
    "버스": ["강서센터", "강북센터", "강동센터", "강남센터", "리페어팀",
             "대전센터", "고속/시외", "티머니(버스)", "외부창고", "에이텍본사"],
    "택시": ["택시지원파트", "리페어팀", "티머니(택시)", "에이텍본사", "외부창고"],
}
